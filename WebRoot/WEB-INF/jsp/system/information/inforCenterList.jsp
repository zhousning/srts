...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="resource/css/information/inforCenterList.css">
	<script type="text/javascript" src="resource/script/jquery/jquery.min.js"></script>
	<script type="text/javascript" src="resource/js/information/inforCenterList.js"></script>
      ...
      <tbody id="self_add">
        <s:iterator value="pageBean.list" status="stt">
          <tr>
            ...
            <td id="number"><a href="info/InformationCenterAction_informationCenterDisp?id=${id}">${noticeTitle }</a></td>
            <td>${noticeType }</td>
            <td>${establishDate }</td>
            <td>${user.username}</td>
          </tr>
