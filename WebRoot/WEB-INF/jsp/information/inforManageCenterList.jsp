		...
		<div class="mainDiv">
			...
			<div class="panel_main">
				<div class="title_main">
					<span class="span_item"> 通知管理 </span>
					<span class="span_item" style="margin-left: 75%"> <!-- <a href="javascript:getId();">删除</a> -->
						...
						<table width="90%" class="table">
							...
							<s:iterator value="pageBean.list" status="stt">
								<tr>
									...
									<td>
										<a
											href="info/InforManageCenterAction_inforManageCenterDisp.action?id=${id}">${noticeTitle
											} </a>
									</td>
									<td>
										${noticeType }
									...
									<td>
										<a
											href="info/InforManageCenterAction_inforManageUpdateDisp.action?id=${id }">修改</a>
									</td>
								</tr>
							</s:iterator>
						</table>
