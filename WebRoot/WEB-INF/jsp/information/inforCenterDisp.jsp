...
<html>
	...
	-->
		...
		<link rel="stylesheet" type="text/css"
			href="resource/css/information/inforCenterDisp.css">
			...
			<div class="panel_main">
				...
				<div class="content_margin">
					...
					<div class="article_main">
						<p>
							${trainNotice.noticeContent}
						</p>

						<p>
							附件：
							<a
								href="info/InformationCenterAction_informationCenterDownload.action?noticeAttach=${trainNotice.noticeAttach}">${trainNotice.noticeAttach}</a>
							<br />
