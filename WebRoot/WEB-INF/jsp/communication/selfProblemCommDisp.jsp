...
<head>
	...
	<link rel="stylesheet" type="text/css" href="resource/css/communication/selfProblemCommDisp.css">
	
	<script type="text/javascript" src="resource/script/jquery/jquery.min.js"></script>
	<script type="text/javascript" src="resource/js/communication/selfProblemCommDisp.js"></script>
</head>
<body>
